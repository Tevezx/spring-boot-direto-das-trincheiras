...
public class UserController {
    ...
    @PostMapping()
    public ResponseEntity<UserPostResponse> save(@RequestBody RequestPostUser requestPostUser) {
    ...
    @PutMapping()
    public ResponseEntity<Void> update(@RequestBody RequestPutUser requestPutUser) {
